...
<div class="ic-prw-main ic-prw-main-singlestep ic-preview-custom-pbc">
    ...
    <div class="ic-prw-sections">
        <div class="ic-prw-section-left">
            ...
            <div class="ic-prw-shipping ic-preview-custom-bc ic-preview-custom-cr">
                <div class="ic-prw-shipping-single ic-preview-custom-bc ic-preview-custom-stc">
                    <div class="ic-prw-shipping-single-left">
                        <input type="radio" name="second" id="" checked />
                        <div class="ic-prw-shipping-method ic-preview-custom-stc">Flat rate:</div>
                    </div>
                    <span class="ic-prw-shipping-price ic-preview-custom-stc">20.00$</span>
                </div>
                <div class="ic-prw-shipping-single">
                    <div class="ic-prw-shipping-single-left">
                        <input type="radio" name="second" id="" disabled />
                        <div class="ic-prw-shipping-method ic-preview-custom-stc">Free shipping</div>
                    </div>
                    <span class="ic-prw-shipping-price ic-preview-custom-stc">Free</span>
                </div>
            </div>
        </div>
        <div class="ic-prw-section-right ic-preview-custom-bc">
            <div
                    class="ic-prw-summary-box ic-preview-custom-cr ic-preview-custom-bc ic-preview-custom-pbc ic-preview-custom-cr">
                ...
                <div class="ic-prw-summary-products">
                    <div class="ic-prw-summary-single-product ic-preview-custom-stc">
                        <div class="ic-prw-summary-single-product-left">
                            <img class="ic-preview-custom-cr" src="<?php echo plugins_url() . '/mediya-checkout/assets/images/theme-plugin-placeholder.webp'; ?>"
                ...
                <div class="ic-prw-total">
                    ...
                    <div class="ic-prw-total-row-final ic-preview-custom-ptc">
                        <span> <?php
                            if ( isset( $custom_text[ 'ic_ct_c_total_label' ] ) && $custom_text[ 'ic_ct_c_total_label' ] != ''  ) {
                                $ic_ct_c_total_label = $custom_text[ 'ic_ct_c_total_label' ];
                                echo $ic_ct_c_total_label;
                            } else {
                                echo $ic_ct_c_total_label;
                            }
                ...
                <div class="ic-prw-payment-methods-head ic-preview-custom-bc ic-preview-custom-ptc">
                    <?php
                    if ( isset( $custom_text[ 'ic_ct_c_payment_method_label' ] ) && $custom_text[ 'ic_ct_c_payment_method_label' ] != ''  ) {
                        $ic_ct_c_payment_method_label = $custom_text[ 'ic_ct_c_payment_method_label' ];
                        echo $ic_ct_c_payment_method_label;
                    } else {
                        echo $ic_ct_c_payment_method_label;
                    }
                    ?>
                </div>
                <div class="ic-prw-payment-methods-row ic-preview-custom-bc ic-preview-custom-cr">
                    <div class="ic-prw-payment-methods-single ic-preview-custom-bc ic-preview-custom-stc">
                        <input type="radio" name="first" id="" checked />
                        Direct bank transfer
                    </div>
                    <div
                            class="ic-prw-payment-methods-single-down ic-preview-custom-bc ic-preview-custom-stc ic-preview-custom-sbc">
                        Make your payment directly into our bank account. Please use
                        your Order ID as the payment reference. Your order will not be
                        shipped until the funds have cleared in our account.
                    </div>
                    <div class="ic-prw-payment-methods-single ic-preview-custom-bc ic-preview-custom-stc">
                        <input type="radio" name="first" id="" disabled />
                        Cash on Delivery
                    </div>
                    <div class="ic-prw-payment-methods-single ic-preview-custom-bc ic-preview-custom-stc">
                        <input type="radio" name="first" id="" disabled />
                ...
                <div class="ic-prw-place-order-button">
                    <button class="ic-preview-custom-pbbc ic-preview-custom-pbtc ic-preview-custom-cr">
                        <?php
                        if ( isset( $custom_text[ 'ic_ct_c_confirm_order_button_label' ] ) && $custom_text[ 'ic_ct_c_confirm_order_button_label' ] != ''  ) {
                            $ic_ct_c_confirm_order_button_label = $custom_text[ 'ic_ct_c_confirm_order_button_label' ];
                            echo $ic_ct_c_confirm_order_button_label;
                        } else {
                            echo $ic_ct_c_confirm_order_button_label;
                        }
                        ?>
            ...
            <div class="ic-prw-dont-miss ic-preview-custom-bc ic-preview-custom-cr">
                <div class="ic-prw-dont-miss-text ic-preview-custom-sbc ic-preview-custom-ptc">
                    <?php
                ...
                <div class="ic-prw-dont-miss-box-wrapper">
                    <div class="ic-prw-dont-miss-box ic-preview-custom-sbc ic-preview-custom-cr">
                        <div class="ic-prw-dont-miss-box-left">
                            <img class="ic-preview-custom-cr" src="<?php echo plugins_url() . '/mediya-checkout/assets/images/theme-plugin-placeholder.webp'; ?>"
                                 alt="" />
                            <div>
                                <div class="ic-prw-dont-miss-box-text ic-preview-custom-ptc">Product name</div>
                                <div class="ic-prw-dont-miss-box-price ic-preview-custom-stc">Price</div>
                            </div>
                        </div>
                        <div class="ic-prw-dont-miss-box-right">
                            <a href="#" class="ic-preview-custom-sbtc ic-preview-custom-sbbc ic-preview-custom-cr"> <?php
            ...
            <div class="ic-prw-payment-trust">
                <div class="ic-prw-payment-trust-single ic-preview-custom-bc">
                    <img class="ic-preview-custom-cr"
                         src="<?php echo plugins_url() . '/mediya-checkout/assets/images/theme-plugin-placeholder.webp'; ?>" alt="" />
                    <div class="ic-prw-payment-trust-single-box">
                        <div class="ic-prw-payment-trust-single-name ic-preview-custom-ptc">Name</div>
                        <div class="ic-prw-payment-trust-single-description ic-preview-custom-stc">
                            Safe payment
                        </div>
                    </div>
                </div>
                ...
                <div class="ic-prw-payment-trust-single ic-preview-custom-bc">
                    <img class="ic-preview-custom-cr"
                         src="<?php echo plugins_url() . '/mediya-checkout/assets/images/theme-plugin-placeholder.webp'; ?>" alt="" />
                    <div class="ic-prw-payment-trust-single-box">
                        <div class="ic-prw-payment-trust-single-name ic-preview-custom-stc">Name</div>
                        <div class="ic-prw-payment-trust-single-description ic-preview-custom-ptc">
                            Safe payment
                        </div>
                    </div>
                </div>
    ...
    <div class="ic-prw-privacy-policy ic-preview-custom-bc">
        <div class="ic-prw-privacy-policy-text ic-preview-custom-stc">
            <?php
